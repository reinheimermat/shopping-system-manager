public class ValidadorEtapa1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(loja1.getQuantidadeFuncionarios() == 5 ? "[OK] Método Loja.getQuantidadeFuncionarios()"
				: "[NOK] Método Loja.getQuantidadeFuncionarios()");
		...
		System.out.println(loja1.getSalarioBaseFuncionario() == -1 ? "[OK] Método Loja.getSalarioBaseFuncionario()"
				: "[NOK] Método Loja.getSalarioBaseFuncionario()");
		...
		System.out.println(loja1.gastosComSalario() == 9000 ? "[OK] Método Loja.gastosComSalario()"
				: "[NOK] Método Loja.gastosComSalario()");

		// public char tamanhoDaLoja();
		System.out.println(loja1.tamanhoDaLoja() == 'P' ? "[OK] Método Loja.tamanhoDaLoja()"
				: "[NOK] Método Loja.tamanhoDaLoja()");
		...
		// public String getNome();
		System.out.println(p1.getNome().equals("Cubo maravilha") ? "[OK] Método Produto.getNome()"
				: "[NOK] Método Produto.getNome()");
		...
		System.out.println(e1.getNomeDaRua().equals("Bla") ? "[OK] Método Endereco.getNomeDaRua()"
				: "[NOK] Método Endereco.getNomeDaRua()");
		...
		System.out.println(e1.getCidade().equals("São Leopoldo") ? "[OK] Método Endereco.getCidade()"
				: "[NOK] Método Endereco.getCidade()");
		...
		System.out.println(
				e1.getEstado().equals("RS") ? "[OK] Método Endereco.getEstado()" : "[NOK] Método Endereco.getEstado()");
		...
		System.out.println(
				e1.getPais().equals("Brasil") ? "[OK] Método Endereco.getPais()" : "[NOK] Método Endereco.getPais()");
		...
		System.out.println(
				e1.getCep().equals("99999-000") ? "[OK] Método Endereco.getCep()" : "[NOK] Método Endereco.getCep()");
		...
		System.out.println(
				e1.getNumero().equals("50") ? "[OK] Método Endereco.getNumero()" : "[NOK] Método Endereco.getNumero()");
		...
		System.out.println(e1.getComplemento().equals("apto 502") ? "[OK] Método Endereco.getComplemento()"
				: "[NOK] Método Endereco.getComplemento()");
		...
		System.out.println(d1.verificaAnoBissexto() ? "[OK] Método Dia.verificaAnoBissexto()"
				: "[NOK] Método Dia.verificaAnoBissexto()");
